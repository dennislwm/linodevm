...
variable str_user_pass {
  description = "user password required for NoIP.com"
}
...
variable str_ssh_id_private {
  default     = "id_linodevm"
  description = "Name of local SSH private_key file"
}
variable str_root_path {
  default     = "/Users/dennislee/fx-git-pull/19linodevm"
